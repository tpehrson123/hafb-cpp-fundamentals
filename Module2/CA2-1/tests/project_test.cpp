...
TEST_CASE("Project default constructor sets values expected", "[start]") {
  ...
  REQUIRE(project.estimated_time_minutes() == 60);
  REQUIRE(fabs(project.estimated_time_hours() - 60 / 60.0) < .0001);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(fabs(project.actual_time_hours() - 0) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
TEST_CASE("Project constructor using two arguments sets values expected",
          "[start]") {
  Project project("testing", 373);

  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 373 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 373) < .0001);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(fabs(project.actual_time_hours() - 0) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 36.8 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 36.8) < .0001);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(fabs(project.actual_time_hours() - 0) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 36.2 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 36.2) < .0001);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(fabs(project.actual_time_hours() - 0) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
TEST_CASE("Project constructor using three arguments sets values expected",
  ...
  REQUIRE(project.name() == "testing spaces too");
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 82.9 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82.9) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 82.1 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82.1) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE("Project constructor using four arguments sets values expected",
  ...
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
TEST_CASE(
    "Project constructor throws out_of_range exception when estimated "
    "time sent is a negative number",
    "[start]") {
  REQUIRE_THROWS_AS(Project("testing2", -2, 82, 12), std::out_of_range);
}
...
TEST_CASE(
    ...
    "is zero",
    "[start]") {
  REQUIRE_THROWS_AS(Project("testing2", 0, 8, 12), std::out_of_range);
}
...
TEST_CASE(
    ...
    "is negative",
    "[start]") {
  REQUIRE_THROWS_AS(Project("testing2", -2, 7, 12), std::out_of_range);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == .1 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - .1) < .0001);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(fabs(project.actual_time_hours() - 0) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == .75 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - .75) < .0001);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(fabs(project.actual_time_hours() - 0) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 23 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 23) < .0001);
  REQUIRE(project.actual_time_minutes() == 36);
  REQUIRE(fabs(project.actual_time_hours() - .6) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 18 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 18) < .0001);
  REQUIRE(project.actual_time_minutes() == 12);
  REQUIRE(fabs(project.actual_time_hours() - .2) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE("The name setter changes the name as expected", "[start]") {
  ...
  REQUIRE(project.name() == "changed up name");
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 128);
  REQUIRE(fabs(project.estimated_time_hours() - 128 / 60.0) < .0001);
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 45);
  REQUIRE(fabs(project.estimated_time_hours() - 45 / 60.0) < .0001);
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE_THROWS_AS(project.set_estimated_time_minutes(0), std::out_of_range);
}
...
TEST_CASE(
    ...
    "[start]") {
  Project project("testing2", 32, 7, 12);
  REQUIRE_THROWS_AS(project.set_estimated_time_minutes(-22), std::out_of_range);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == 6 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 6) < .0001);
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing");
  REQUIRE(project.estimated_time_minutes() == .2 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - .2) < .0001);
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing spaces too");
  REQUIRE(project.estimated_time_minutes() == 2.6 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 2.6) < .0001);
  REQUIRE(project.actual_time_minutes() == 63.8 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 63.8) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.name() == "testing spaces too");
  REQUIRE(project.estimated_time_minutes() == 2.4 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 2.4) < .0001);
  REQUIRE(project.actual_time_minutes() == 91.4 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 91.4) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 128);
  REQUIRE(fabs(project.actual_time_hours() - 128 / 60.0) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 45);
  REQUIRE(fabs(project.actual_time_hours() - .75) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
    ...
    "[start]") {
  Project project("testing2", 32, 7, 12);
  REQUIRE_THROWS_AS(project.set_actual_time_minutes(-1), std::out_of_range);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 6 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 6) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == .2 * 60);
  REQUIRE(fabs(project.actual_time_hours() - .2) < .0001);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 2.6 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 2.6) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 390 * 60);
  REQUIRE(fabs(project.estimated_time_hours() - 390) < .0001);
  REQUIRE(project.actual_time_minutes() == 2.4 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 2.4) < .0001);
  REQUIRE(project.reported_percent_complete() == 0);
}
...
TEST_CASE(
    ...
    "[start]") {
  Project project("testing2", 32, 7, 12);
  REQUIRE_THROWS_AS(project.set_actual_time_hours(-1), std::out_of_range);
}
...
TEST_CASE(
  ...
  REQUIRE(project.actual_time_minutes() == 82 * 60);
  REQUIRE(fabs(project.actual_time_hours() - 82) < .0001);
  REQUIRE(project.reported_percent_complete() == 18);
}
...
TEST_CASE(
    ...
    "[start]") {
  Project project("testing2", 32, 7, 12);
  REQUIRE_THROWS_AS(project.set_percent_complete(101), std::out_of_range);
}
...
TEST_CASE(
    ...
    "[start]") {
  Project project("testing2", 32, 7, 12);
  REQUIRE_THROWS_AS(project.set_percent_complete(-1), std::out_of_range);
}
...
TEST_CASE(
  ...
  REQUIRE(project.actual_time_minutes() == 1161);
  REQUIRE(project.reported_percent_complete() == 80);
}
...
TEST_CASE(
  ...
  REQUIRE(project.actual_time_minutes() == 218);
  REQUIRE(project.reported_percent_complete() == 12);
}
...
TEST_CASE(
  ...
  REQUIRE_THROWS_AS(project.RecordTimeSpentMinutes(-61, 15), std::out_of_range);
}
...
TEST_CASE(
  ...
  REQUIRE(project.actual_time_minutes() == 600);
  REQUIRE(project.reported_percent_complete() == 50);
}
...
TEST_CASE(
  ...
  REQUIRE(project.actual_time_minutes() == 210);
  REQUIRE(project.reported_percent_complete() == 8);
}
...
TEST_CASE(
  ...
  REQUIRE(project.actual_time_minutes() == 270);
  REQUIRE(project.reported_percent_complete() == 6);
}
...
TEST_CASE(
    ...
    "[record_time]") {
  Project project("testing2", 32, 1, 12);
  REQUIRE_THROWS_AS(project.RecordTimeSpentMinutes(-1.1, 15),
                    std::out_of_range);
}
...
TEST_CASE("ConvertMinutesToString returns 2:15 when 135 is sent.",
  ...
  REQUIRE(project.ConvertMinutesToString(135) == "2:15");
}
...
TEST_CASE("ConvertMinutesToString returns 3:08 when 188 is sent.",
  ...
  REQUIRE(project.ConvertMinutesToString(188) == "3:08");
}
...
TEST_CASE("ConvertMinutesToString returns 412:16 when 24736 is sent.",
  ...
  REQUIRE(project.ConvertMinutesToString(24736) == "412:16");
}

TEST_CASE("ConvertMinutesToString returns 0:51 when 51 is sent.", "[convert]") {
  Project project;

  REQUIRE(project.ConvertMinutesToString(51) == "0:51");
}
...
TEST_CASE("ConvertMinutesToString returns -12:54 when -774 is sent.",
  ...
  REQUIRE(project.ConvertMinutesToString(-774) == "-12:54");
}
...
TEST_CASE("TimeLeftOnProject reports 32:18 when minutes left is 1944.",
  ...
  REQUIRE(project.estimated_time_minutes() == 33 * 60);
  REQUIRE(project.actual_time_minutes() == 42);
  REQUIRE(project.TimeLeftOnProject() == "32:18");
}
...
TEST_CASE("TimeLeftOnProject reports 0:24 when minutes left is 24.",
  ...
  REQUIRE(project.estimated_time_minutes() == 1 * 60);
  REQUIRE(project.actual_time_minutes() == 36);
  REQUIRE(project.TimeLeftOnProject() == "0:24");
}
...
TEST_CASE("TimeLeftOnProject reports 22:00 when minutes left is 1320.",
  ...
  REQUIRE(project.estimated_time_minutes() == 22 * 60);
  REQUIRE(project.actual_time_minutes() == 0);
  REQUIRE(project.TimeLeftOnProject() == "22:00");
}
...
TEST_CASE(
  ...
  REQUIRE(project.estimated_time_minutes() == 22 * 60);
  REQUIRE(project.actual_time_minutes() == 24.8 * 60);
  REQUIRE(project.TimeLeftOnProject() == "-2:48");
}
...
TEST_CASE(
  ...
  std::string line;
  getline(in, line);
  REQUIRE(line == "1320 90 12");
  getline(in, line);
  REQUIRE(line == "Test Project");
  getline(in, line);
  REQUIRE(line == "");
...
TEST_CASE(
  ...
  std::string line;
  getline(in, line);
  REQUIRE(line == "30 15 42");
  getline(in, line);
  REQUIRE(line == "Fast Project");
  getline(in, line);
  REQUIRE(line == "");
...
TEST_CASE(
  ...
  std::string line;
  getline(in, line);
  REQUIRE(line == "360 450 95");
  getline(in, line);
  REQUIRE(line == "Over Project");
  getline(in, line);
  REQUIRE(line == "");
...
TEST_CASE(
  ...
  REQUIRE(project.ConvertMinutesToString(1320) == "22:00");
  REQUIRE(project.ConvertMinutesToString(90) == "1:30");
  REQUIRE(project.CalculatedPercentComplete() == 7);
  REQUIRE(project.reported_percent_complete() == 12);
  ...
  REQUIRE(line == "Test Project");
  getline(in, line);
  REQUIRE(line == "Estimated time: 22:00");
  getline(in, line);
  REQUIRE(line == "Actual time spent: 1:30");
  getline(in, line);
  REQUIRE(line == "Calculated percent complete: 7%");
  getline(in, line);
  REQUIRE(line == "Reported percent complete: 12%");
  getline(in, line);
  REQUIRE(line == "");
...
TEST_CASE(
  ...
  REQUIRE(project.ConvertMinutesToString(30) == "0:30");
  REQUIRE(project.ConvertMinutesToString(15) == "0:15");
  REQUIRE(project.CalculatedPercentComplete() == 50);
  REQUIRE(project.reported_percent_complete() == 42);
  ...
  REQUIRE(line == "Fast Project");
  getline(in, line);
  REQUIRE(line == "Estimated time: 0:30");
  getline(in, line);
  REQUIRE(line == "Actual time spent: 0:15");
  getline(in, line);
  REQUIRE(line == "Calculated percent complete: 50%");
  getline(in, line);
  REQUIRE(line == "Reported percent complete: 42%");
  getline(in, line);
  REQUIRE(line == "");
...
TEST_CASE(
  ...
  REQUIRE(project.ConvertMinutesToString(360) == "6:00");
  REQUIRE(project.ConvertMinutesToString(450) == "7:30");
  REQUIRE(project.CalculatedPercentComplete() == 125);
  REQUIRE(project.reported_percent_complete() == 95);
  ...
  REQUIRE(line == "Over Project");
  getline(in, line);
  REQUIRE(line == "Estimated time: 6:00");
  getline(in, line);
  REQUIRE(line == "Actual time spent: 7:30");
  getline(in, line);
  REQUIRE(line == "Calculated percent complete: 125%");
  getline(in, line);
  REQUIRE(line == "Reported percent complete: 95%");
  getline(in, line);
  REQUIRE(line == "");
...
TEST_CASE(
  ...
  REQUIRE(project1.ConvertMinutesToString(360) == "6:00");
  REQUIRE(project1.ConvertMinutesToString(450) == "7:30");
  REQUIRE(project1.CalculatedPercentComplete() == 125);
  REQUIRE(project1.reported_percent_complete() == 95);

  REQUIRE(project2.ConvertMinutesToString(1320) == "22:00");
  REQUIRE(project2.ConvertMinutesToString(90) == "1:30");
  REQUIRE(project2.CalculatedPercentComplete() == 7);
  REQUIRE(project2.reported_percent_complete() == 12);

  REQUIRE(project3.ConvertMinutesToString(30) == "0:30");
  REQUIRE(project3.ConvertMinutesToString(15) == "0:15");
  REQUIRE(project3.CalculatedPercentComplete() == 50);
  REQUIRE(project3.reported_percent_complete() == 42);
