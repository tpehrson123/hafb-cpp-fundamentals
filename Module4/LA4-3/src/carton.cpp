...
/**
 * @brief returns true if the volume of the left hand Carton is greater than
 * the volume right hand Carton
 *
 * @param rhs - carton on the right side of >
 * @return true - when left side carton has a larger volume
 * @return false - when right side carton has a larger volume
 */
