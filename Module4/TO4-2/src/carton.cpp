...
/**
 * @brief returns true if the volume of the left hand carton is larger
 * than the volume of the right hand carton
 *
 * @param rhs - carton on the right side of >
 * @return true - when left side volume is greater than right side volume
 * @return false - when left side volume is not greater than right side volume
 */
